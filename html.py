...
def createHTMLtableFromSeries(series, listofheaders):
	htmltable = '<table><tr>'
...
def createCarRepresentation(cars, attribute):
    ...
    for index, car in cars.iterrows():
        ...
        if attribute == 'price':
            ...
            rep += "</p><p>From 0-100 kmt/t: " + str(car.Kmt) + "secs </p></div>"
        elif attribute == 'kml':
            rep += "</p><p>Kilometers per liter: " + str(car.Kml) + "km/l </p></div>"
        print rep
